...
console.log(a, b ,c ) tornando todos com a mesma resposta "a" "b" "c".
*/
...
//3. imprima na tela i tipo dessas variaveis que acabou de criar, usando o comando typeof.
...
as variaveis 'nome' e 'idade' foram declaradas, mas não foram inicializados com valores. portanto, o tipo impresso é "undefined"
*/

//5.pergunte ao usuario seu nomee sau idade, atribuindo esses dois valores as variaveis que acabou de criar.

//nome = prompt("qual é o seu nome");
//idade = prompt("qual é a sua idade");

//imprima  na tela o tipo dessas variaveis.
//console.log(typeof nome);  // deve imprimir "string"
//console.log(typeof idade); // deve imprimir "string"

/*
7.para finalizar, imprima na tela a mensagem "ola 'nome', voce tem idade anos". onde 'nome' e 'idade' são os valores que o usuario inseriu.
